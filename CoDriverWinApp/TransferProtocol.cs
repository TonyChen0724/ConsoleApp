...
namespace CoDriverWinApp
{
    ...
    class TransferProtocol
    {
        ...
        {
            string msg = string.Format("4#{0}", taskData);
            return msg;
        }
        static public string Msg_RequestVideoList_CS(string taskData)
        {
            string msg = string.Format("4#{0}", taskData);
            return msg;
        }
        ...
        static public string Msg_RequestDownloadImages_CS(string taskData)
        {
            string msg = string.Format("6#1#{0}", taskData);
            return msg;
        }
        static public string Msg_RequestDownloadVideo_CS(string taskData)
        {
